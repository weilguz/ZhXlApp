...
public class BgDarkPopupWindow extends PopupWindow {
    ...
    public BgDarkPopupWindow(Context context, View contentView) {
        super(contentView, YogaViewUtil.getScreenWidth(context), 0);
        this.setHeight(setPwHeight(context, contentView));/**设置高度*/
        if (contentView != null) {
    ...
    public BgDarkPopupWindow(View contentView, int width, int height) {
    ...
    public int setPwHeight(Context context, View view) {
        if (YogaViewUtil.px2dp(context, YogaViewUtil.getScreenHeight(context))/2 < YogaViewUtil.getViewHeight(view)) {
            return YogaViewUtil.getScreenHeight(context) / 2;
        } else {
            return (int) YogaViewUtil.dp2px(context, YogaViewUtil.getViewHeight(view));
        }
    }
     ...
     * 设置 显示位置
     */
    public void setShowPosition(boolean isTop){
        this.mIsTop = isTop;
    }
