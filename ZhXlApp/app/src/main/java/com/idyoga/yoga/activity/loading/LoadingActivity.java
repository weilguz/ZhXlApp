...
public class LoadingActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    @BindView(com.idyoga.yoga.R.id.guide_vp)
    ViewPager guideVp;
    @BindView(com.idyoga.yoga.R.id.guide_iv)
    ImageView guideIv;
    ...
    protected void initData() {
        list.add(R.drawable.yoga_guide_1);
        list.add(R.drawable.yoga_guide_2);
        list.add(R.drawable.yoga_guide_3);
        initViewPager();
    }
    @Override
    ...
    protected int setLayoutId() {
        return com.idyoga.yoga.R.layout.activity_loading;
    }
...
//        mBannerView.start();
    ...
    @OnClick(com.idyoga.yoga.R.id.guide_iv)
