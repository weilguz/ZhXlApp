...
public abstract class RvCommonAdapter <T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public RvCommonAdapter setOnItemClickListener(OnRvItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
        return this;
    }

    public OnRvItemClickListener getmOnItemClickListener() {
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        final ViewHolder viewHolder = ViewHolder.get(mContext, null, parent, mLayoutId, -1);
