 ...
 * 修改备注：
 */
public class ShopListActivity extends BaseActivity implements ICommonViewUi {
    ...
    protected void initImmersionBar() {
        ...
        mImmersionBar.flymeOSStatusBarFontColor("#333333").titleBar(mLlCommonLayout).init();
    }
