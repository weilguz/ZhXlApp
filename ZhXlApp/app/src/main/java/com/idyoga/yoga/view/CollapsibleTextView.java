...
public class CollapsibleTextView extends AppCompatTextView implements ViewTreeObserver.OnPreDrawListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                mMaxLine = ta.getInteger(R.styleable.CollapsibleTextView_maxLine,3);
            } finally {
                ta.recycle();
            }
        }
    ...
    private void resetText(int height) {
        ...
        if (lineCount > 3 && mIsShowMore){
            text = preHandleCollapsedText(layout, mMaxLine);
        }else{
            text = preHandleCollapsedText(layout, lineCount);
        }
        super.setText(buildCollapsedText(text, mMaxLine), BufferType.NORMAL);
        ...
        /*if (lineCount > 0 && textHeight > 0) {
            ...
            Logcat.i("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% lineCount = " + lineCount + " maxLines = " + maxLines);
