...
public class SpannableHelper {
     ...
     * @return {@link Builder}
     */
    public static Builder Builder(Context context,@NonNull CharSequence text) {
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (size!=-1){
                mBuilder.setSpan(new AbsoluteSizeSpan(DensityUtil.sp2px(context, size)), start, end,flag);
                size=-1;
            }
