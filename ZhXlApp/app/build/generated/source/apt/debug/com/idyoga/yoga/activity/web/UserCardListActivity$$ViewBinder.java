...
public class UserCardListActivity$$ViewBinder<T extends UserCardListActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends UserCardListActivity> implements Unbinder {
    private T target;
