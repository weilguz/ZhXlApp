...
public class FragmentCourseByOffline$$ViewBinder<T extends FragmentCourseByOffline> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends FragmentCourseByOffline> implements Unbinder {
    private T target;
