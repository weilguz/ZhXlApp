...
public class ClassifyChooseActivity$$ViewBinder<T extends ClassifyChooseActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ClassifyChooseActivity> implements Unbinder {
    private T target;
