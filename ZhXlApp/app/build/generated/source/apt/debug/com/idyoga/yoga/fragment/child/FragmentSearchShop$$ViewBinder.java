...
public class FragmentSearchShop$$ViewBinder<T extends FragmentSearchShop> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends FragmentSearchShop> implements Unbinder {
    private T target;
