...
public class VideoClassifyListActivity$$ViewBinder<T extends VideoClassifyListActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends VideoClassifyListActivity> implements Unbinder {
    private T target;
