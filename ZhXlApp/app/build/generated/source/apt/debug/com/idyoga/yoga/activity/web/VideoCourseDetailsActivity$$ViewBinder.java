...
public class VideoCourseDetailsActivity$$ViewBinder<T extends VideoCourseDetailsActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends VideoCourseDetailsActivity> implements Unbinder {
    private T target;
