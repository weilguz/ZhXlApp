...
public class TutorSelectActivity$$ViewBinder<T extends TutorSelectActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends TutorSelectActivity> implements Unbinder {
    private T target;
