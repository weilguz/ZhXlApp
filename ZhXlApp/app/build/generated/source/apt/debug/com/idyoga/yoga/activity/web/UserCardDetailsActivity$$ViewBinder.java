...
public class UserCardDetailsActivity$$ViewBinder<T extends UserCardDetailsActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends UserCardDetailsActivity> implements Unbinder {
    private T target;
