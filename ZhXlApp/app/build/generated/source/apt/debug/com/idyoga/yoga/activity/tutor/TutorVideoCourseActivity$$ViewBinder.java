...
public class TutorVideoCourseActivity$$ViewBinder<T extends TutorVideoCourseActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends TutorVideoCourseActivity> implements Unbinder {
    private T target;
