...
public class ShopSelectActivity$$ViewBinder<T extends ShopSelectActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ShopSelectActivity> implements Unbinder {
    private T target;
