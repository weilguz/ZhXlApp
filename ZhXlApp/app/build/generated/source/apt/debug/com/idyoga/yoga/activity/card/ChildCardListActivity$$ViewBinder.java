...
public class ChildCardListActivity$$ViewBinder<T extends ChildCardListActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ChildCardListActivity> implements Unbinder {
    private T target;
