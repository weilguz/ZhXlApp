...
public class ConsultActivity$$ViewBinder<T extends ConsultActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ConsultActivity> implements Unbinder {
    private T target;
