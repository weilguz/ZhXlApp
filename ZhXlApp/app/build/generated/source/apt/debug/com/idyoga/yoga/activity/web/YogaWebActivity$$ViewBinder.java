...
public class YogaWebActivity$$ViewBinder<T extends YogaWebActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131231205, "field 'mLlWebBack' and method 'onViewClicked'");
    target.mLlWebBack = finder.castView(view, 2131231205, "field 'mLlWebBack'");
    ...
    view = finder.findRequiredView(source, 2131231206, "field 'mLlWebClose' and method 'onViewClicked'");
    target.mLlWebClose = finder.castView(view, 2131231206, "field 'mLlWebClose'");
    unbinder.view2131231206 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onViewClicked(p0);
    ...
    view = finder.findRequiredView(source, 2131231773, "field 'mTvWebTitle'");
    target.mTvWebTitle = finder.castView(view, 2131231773, "field 'mTvWebTitle'");
    view = finder.findRequiredView(source, 2131231208, "field 'mLlWebMore' and method 'onViewClicked'");
    target.mLlWebMore = finder.castView(view, 2131231208, "field 'mLlWebMore'");
