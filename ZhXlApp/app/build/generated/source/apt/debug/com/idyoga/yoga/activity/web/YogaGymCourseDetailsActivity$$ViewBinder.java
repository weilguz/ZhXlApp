...
public class YogaGymCourseDetailsActivity$$ViewBinder<T extends YogaGymCourseDetailsActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends YogaGymCourseDetailsActivity> implements Unbinder {
    private T target;
