...
public class FragmentSearchAll$$ViewBinder<T extends FragmentSearchAll> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends FragmentSearchAll> implements Unbinder {
    private T target;
