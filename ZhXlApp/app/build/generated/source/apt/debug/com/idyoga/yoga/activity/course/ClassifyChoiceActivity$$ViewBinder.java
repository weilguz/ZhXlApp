...
public class ClassifyChoiceActivity$$ViewBinder<T extends ClassifyChoiceActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ClassifyChoiceActivity> implements Unbinder {
    private T target;
