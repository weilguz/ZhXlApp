...
public class MembershipCardActivity2$$ViewBinder<T extends MembershipCardActivity2> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    InnerUnbinder unbinder = createUnbinder(target);
    View view;
    view = finder.findRequiredView(source, 2131231199, "field 'mLlTitleBack', method 'onViewClicked', and method 'onViewClicked'");
  ...
  protected static class InnerUnbinder<T extends MembershipCardActivity2> implements Unbinder {
    private T target;
