...
public class VideoClassifyActivity$$ViewBinder<T extends VideoClassifyActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends VideoClassifyActivity> implements Unbinder {
    private T target;
