...
public class FragmentSearchTutor$$ViewBinder<T extends FragmentSearchTutor> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131231135, "field 'mLayout'");
    target.mLayout = finder.castView(view, 2131231135, "field 'mLayout'");
    return unbinder;
  }
  ...
  protected static class InnerUnbinder<T extends FragmentSearchTutor> implements Unbinder {
    private T target;
