...
public class InValidChildCardListActivity$$ViewBinder<T extends InValidChildCardListActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends InValidChildCardListActivity> implements Unbinder {
    private T target;
