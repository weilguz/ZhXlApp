...
public class ShopImagesActivity$$ViewBinder<T extends ShopImagesActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131230976, "field 'mHomeTabs'");
    target.mHomeTabs = finder.castView(view, 2131230976, "field 'mHomeTabs'");
    view = finder.findRequiredView(source, 2131230977, "field 'mHomeVpContent'");
    target.mHomeVpContent = finder.castView(view, 2131230977, "field 'mHomeVpContent'");
    return unbinder;
  }
