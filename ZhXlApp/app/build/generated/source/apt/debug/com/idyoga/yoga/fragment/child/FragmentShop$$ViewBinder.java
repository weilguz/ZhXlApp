...
public class FragmentShop$$ViewBinder<T extends FragmentShop> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends FragmentShop> implements Unbinder {
    private T target;
