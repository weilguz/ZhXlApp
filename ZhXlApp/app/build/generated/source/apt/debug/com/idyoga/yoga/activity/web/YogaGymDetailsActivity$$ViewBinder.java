...
public class YogaGymDetailsActivity$$ViewBinder<T extends YogaGymDetailsActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends YogaGymDetailsActivity> implements Unbinder {
    private T target;
