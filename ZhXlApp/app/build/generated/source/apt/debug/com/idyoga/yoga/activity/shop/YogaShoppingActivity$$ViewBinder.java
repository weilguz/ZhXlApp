...
public class YogaShoppingActivity$$ViewBinder<T extends YogaShoppingActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends YogaShoppingActivity> implements Unbinder {
    private T target;
