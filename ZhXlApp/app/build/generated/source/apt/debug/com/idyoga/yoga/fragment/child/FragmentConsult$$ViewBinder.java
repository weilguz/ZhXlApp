...
public class FragmentConsult$$ViewBinder<T extends FragmentConsult> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends FragmentConsult> implements Unbinder {
    private T target;
