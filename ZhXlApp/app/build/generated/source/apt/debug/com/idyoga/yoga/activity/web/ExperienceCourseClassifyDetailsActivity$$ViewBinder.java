...
public class ExperienceCourseClassifyDetailsActivity$$ViewBinder<T extends ExperienceCourseClassifyDetailsActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ExperienceCourseClassifyDetailsActivity> implements Unbinder {
    private T target;
