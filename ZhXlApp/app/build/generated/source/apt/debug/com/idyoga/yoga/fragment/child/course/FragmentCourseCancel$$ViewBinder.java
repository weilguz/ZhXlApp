...
public class FragmentCourseCancel$$ViewBinder<T extends FragmentCourseCancel> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends FragmentCourseCancel> implements Unbinder {
    private T target;
