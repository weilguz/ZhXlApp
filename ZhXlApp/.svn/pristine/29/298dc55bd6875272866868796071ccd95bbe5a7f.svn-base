 ...
 * 修改备注：
 */
public class TutorRecommendCourseItemAdapter extends BaseQuickAdapter<TutorDetailBean.CourseBean, BaseViewHolder> {
    public TutorRecommendCourseItemAdapter(int layoutResId, @Nullable List<TutorDetailBean.CourseBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, TutorDetailBean.CourseBean bean) {
        ...
        Glide.with(mContext).load(bean.getLessonImg()).placeholder(R.drawable.img_course).error(R.drawable.img_course).into((ImageView) helper.getView(R.id.iv_img));
    }
}
