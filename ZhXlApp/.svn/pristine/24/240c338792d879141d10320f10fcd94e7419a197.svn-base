...
public class WrapLineLayout extends ViewGroup {
    ...
    public WrapLineLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.WrapLineLayout, 0, 0);
        try {
            mLineSpacing = ta.getDimension(R.styleable.WrapLineLayout_lineSpacing, 0);
            mMaxLines = ta.getInt(R.styleable.WrapLineLayout_maxLines, Integer.MAX_VALUE);
    ...
    public WrapLineLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0, j = 0; i < mChildCountNeedLayout; i++) {
            ...
            WrapLineLayout.LayoutParams lp = (LayoutParams) child.getLayoutParams();
            final int leftMargin = lp.leftMargin;
    ...
    private static int getMeasuredWidthWithMargins(View v) {
        WrapLineLayout.LayoutParams lp = (LayoutParams) v.getLayoutParams();
