 ...
 * 修改备注：
 */
public class CitySettingAdapter extends BaseQuickAdapter<CityBean.CityListBean,BaseViewHolder> {

    public CitySettingAdapter(int layoutResId, @Nullable List<CityBean.CityListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, CityBean.CityListBean item) {
