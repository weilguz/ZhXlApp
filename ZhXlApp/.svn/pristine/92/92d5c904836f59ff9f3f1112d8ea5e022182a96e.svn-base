 ...
 * 修改备注：
 */
public class TutorSelectAdapter extends CommonAdapter<ClassifyChoiceActivity.tagBean> {

    private Context mContext;
    List<ClassifyChoiceActivity.tagBean> mBeanList;

    public TutorSelectAdapter(Context context, List<ClassifyChoiceActivity.tagBean> mBeanList, int layoutId) {
