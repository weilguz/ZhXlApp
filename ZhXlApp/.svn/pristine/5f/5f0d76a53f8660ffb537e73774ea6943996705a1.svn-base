...
public class CustomPopupWindow extends PopupWindow {
    private View mView;
    public CustomPopupWindow(Activity context, View.OnClickListener itemsOnClick, String code){
        super(context);
    ...
    public void initView(final Activity context, View.OnClickListener itemsOnClick, String code) {
        ...
        mView = mInflater.inflate(R.layout.pop_common,null);
        ...
        TextView tv_select01= (TextView) mView.findViewById(R.id.tv_select01);
        TextView tv_select02 = (TextView) mView.findViewById(R.id.tv_select02);
        if(code.equals("2")){
