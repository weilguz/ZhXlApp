...
public class HomeRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == EMPTY_VIEW) {
            View view = LayoutInflater.from(context).inflate(com.idyoga.yoga.R.layout.view_list_footer, parent, false);
            ...
            View view = LayoutInflater.from(context).inflate(com.idyoga.yoga.R.layout.item_home_hot, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof EmptyViewHolder) {
            ...
            Glide.with(context)
                    ...
                    .error(com.idyoga.yoga.R.drawable.common_details_carousel_placeholder)
                    .into(eholder.mImg);
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mImg = (ImageView) view.findViewById(com.idyoga.yoga.R.id.iv_home_mall);
            mTitle = (TextView) view.findViewById(com.idyoga.yoga.R.id.tv_title);
            mPrice = (TextView) view.findViewById(com.idyoga.yoga.R.id.tv_price);
            mType = (TextView) view.findViewById(com.idyoga.yoga.R.id.tv_type);
        }
    }
}
