...
public class OkHttpClientManager {
    ...
    private OkHttpClientManager() {
        ...
        builder.networkInterceptors().add(new HttpClient.LoggingInterceptor());
    ...
    public static void postAsyn(String url, File file, String fileKey, Map<String, String> params, ResultCallback callback) throws IOException {
        getInstance().getPostDelegate().postAsyn(url, file, fileKey, params, callback);
    }

    public static void postAsyn(String url, Map<String, File> fileMap, String fileKey, Map<String, String> params, ResultCallback callback) throws IOException {
        getInstance().getPostDelegate().postAsyn(url, fileMap, fileKey, params, callback);
    }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    if (resCallBack.mType == String.class) {
                        sendSuccessResultCallback(call.request(), string, resCallBack);
                    } else {
                        Object o = mGson.fromJson(string, resCallBack.mType);
                        sendSuccessResultCallback(call.request(), o, resCallBack);
                    }
                } catch (IOException e) {
    ...
    public class PostDelegate {
        ...
        public void postAsyn(String url, File file, String fileKey, Map<String, String> params, ResultCallback callback) {

        }

        public void postAsyn(String url, Map<String, File> fileMap, String fileKey, Map<String, String> params, ResultCallback callback) {
