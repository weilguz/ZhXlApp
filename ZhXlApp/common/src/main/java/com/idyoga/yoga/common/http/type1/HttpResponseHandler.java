...
package com.idyoga.yoga.common.http.type1;
    ...
    protected void handleMessage(Message msg) {
        ...
        switch (msg.what) {
           ...
           /*     if(isTokenExpired((String) response[2])){
                    Log.i(TAG,"返回数据 ://// "+(String) response[2]);
                    ...
                    Intent intent = new Intent(AppContext.mContext, MainActivity.class);
...
//        Log.i(TAG,backlogJsonStr);
        if(backlogJsonStr.indexOf("token验证失败")!=-1){
            return true;
        }
        return false;
    }
